          ...
          >
            ...
            <div className="overflow-hidden">
              <motion.h2
                ...
                className="text-4xl md:text-5xl font-black tracking-tighter leading-tight text-[#1d1d1f]"
              >
                A Small Team.
                <br />
            ...
            <div className="overflow-hidden">
              <motion.p variants={maskRevealVariants} className="text-[#6e6e73] text-[17px] leading-relaxed">
          ...
          <div className="grid gap-4">
            {capabilities.map((cap, i) => (
              <motion.div
                ...
                whileHover="hover"
                className="bg-white border border-[#d2d2d7] shadow-sm rounded-xl p-5 flex gap-4 items-start hover:bg-[#f5f5f7] transition-colors duration-300 cursor-default group"
              >
                <motion.div 
                  variants={{
                    hover: { y: -5, scale: 1.1, transition: { type: "spring", stiffness: 300, damping: 10 } }
                  }}
                  className="w-9 h-9 rounded-lg bg-white/80 border border-[#d2d2d7] shadow-sm backdrop-blur-xl border-[rgba(0,113,227,0.1)] flex items-center justify-center flex-shrink-0"
                >
                  {cap.icon}
                </motion.div>
                <div>
